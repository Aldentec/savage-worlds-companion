...
import { createNPC } from "../graphql/mutations";
...
export default function NPCCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createNPC.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "NPCCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
